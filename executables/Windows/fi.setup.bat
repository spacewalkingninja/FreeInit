...
call %conda_path% env create -f environment.yaml --prefix %model_env% -y 
...
IF %skipactive% EQU 1 GOTO dwnow
:dwscr
call %conda_path% activate %model_env%
:dwnow

ECHO.
ECHO %info_h1% Download SD1.5 Model Files%ansi_end%
ECHO %info_h2% This will most probably take a while... %ansi_end%
ECHO %info_h2% Do not close! %ansi_end%
::call git clone https://huggingface.co/runwayml/stable-diffusion-v1-5 models/StableDiffusion/
ECHO.
ECHO %info_h1% Download Extra Model Files%ansi_end%
ECHO %info_h2% This will take a while *not so much... %ansi_end%
ECHO %info_h2% Do not close! %ansi_end%

::call pip install gdown

::call python -m gdown 1RqkQuGPaCO5sGZ6V6KZ-jUWmsRu48Kdq -O models\Motion_Module\
::call python -m gdown 1ql0g_Ys4UCz2RnokYlBjyOYPbttbIpbu -O models\Motion_Module\
powershell -command "(New-Object Net.WebClient).DownloadFile("""https://civitai.com/api/download/models/78775""", """%model_path%\models\DreamBooth_LoRA\toonyou_beta3.safetensors""")"
powershell -command "(New-Object Net.WebClient).DownloadFile("""https://civitai.com/api/download/models/72396""", """%model_path%\models\DreamBooth_LoRA\lyriel_v16.safetensors""")"
powershell -command "(New-Object Net.WebClient).DownloadFile("""https://civitai.com/api/download/models/71009""", """%model_path%\models\DreamBooth_LoRA\rcnzCartoon3d_v10.safetensors""")"
powershell -command "(New-Object Net.WebClient).DownloadFile("""https://civitai.com/api/download/models/79068""", """%model_path%\models\DreamBooth_LoRA\majicmixRealistic_v5Preview.safetensors""")"
powershell -command "(New-Object Net.WebClient).DownloadFile("""https://civitai.com/api/download/models/29460""", """%model_path%\models\DreamBooth_LoRA\realisticVisionV20_v20.safetensors""")"
powershell -command "(New-Object Net.WebClient).DownloadFile("""https://civitai.com/api/download/models/97261""", """%model_path%\models\DreamBooth_LoRA\TUSUN.safetensors""")"
powershell -command "(New-Object Net.WebClient).DownloadFile("""https://civitai.com/api/download/models/50705""", """%model_path%\models\DreamBooth_LoRA\moonfilm_reality20.safetensors""")"
powershell -command "(New-Object Net.WebClient).DownloadFile("""https://civitai.com/api/download/models/90115""", """%model_path%\models\DreamBooth_LoRA\FilmVelvia2.safetensors""")"
powershell -command "(New-Object Net.WebClient).DownloadFile("""https://civitai.com/api/download/models/92475""", """%model_path%\models\DreamBooth_LoRA\majicmixRealistic_v4.safetensors""")"
powershell -command "(New-Object Net.WebClient).DownloadFile("""https://civitai.com/api/download/models/102828""", """%model_path%\models\DreamBooth_LoRA\lora_Ghibli_n3.safetensors""")"
powershell -command "(New-Object Net.WebClient).DownloadFile("""https://civitai.com/api/download/models/57618""", """%model_path%\models\DreamBooth_LoRA\CounterfeitV30_25.safetensors""")"
