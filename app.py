        ...
        with gr.Row():
            with gr.Column():
                ...
                with gr.Accordion("Advance", open=False):
                    with gr.Row():
                        width_slider  = gr.Slider(  label="Width",  value=512, minimum=128, maximum=1024, step=64 )
                        height_slider = gr.Slider(  label="Height", value=512, minimum=128, maximum=1024, step=64 )
                    with gr.Row():
